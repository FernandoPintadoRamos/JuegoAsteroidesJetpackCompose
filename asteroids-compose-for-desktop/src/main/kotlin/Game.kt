...
class Game {
    ...
    fun startGame(modoD:Boolean, c:Color) {
        gameObjects.clear()
    ...
    fun update(time: Long, modoD: Boolean) {
        ...
        /*
        Aqui se comprueba si modoD esta a true o a false
        Si esta a true solo deja disparar una bala a la vez
         */
        if (modoD){
            if (bullets.count() > 1) {
